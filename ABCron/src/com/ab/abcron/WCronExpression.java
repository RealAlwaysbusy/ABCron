...
public class WCronExpression {
    ...
    */
    ...
    public void Initialize(String cronExpression) throws ParseException {
    	this.cronExpression = cronExpression.toUpperCase(Locale.US);
    	buildExpression(this.cronExpression);
    }
    
    protected boolean isSatisfiedBy(Date date) {
    ...
    protected Date getNextValidTimeAfter(Date date) {
    ...
    public boolean isValidExpression(String cronExpression) {        
        try {
        	WCronExpression c = new WCronExpression();
        	c.Initialize(cronExpression);            
    ...
    protected int checkNext(int pos, String s, int val, int type)
        ...
        protected String getExpressionSummary() {
        ...
        public Date getTimeAfter(Date afterTime) {
            ...
            while (!gotOne) {
                ...
                if (dayOfMSpec && !dayOfWSpec) { // get day by day of month rule
                    ...
                    if (lastdayOfWeek) { // are we looking for the last XXXX day of
                        // the month?
                        ...
                        // are we looking for the Nth XXXX day in the month?
                        int dow = daysOfWeek.first(); // desired
                        // d-o-w
                        int cDow = cl.get(Calendar.DAY_OF_WEEK); // current d-o-w
                        int daysToAdd = 0;
